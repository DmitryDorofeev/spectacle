...
var dynamicStyledFitHeaders = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'].reduce(function (memo, tag) {
  ...
  /*#__PURE__*/
  (0, _reactEmotion.default)(tag, {
    target: "e1nkgrqo2"
  })(dynamicHeaderFitStyles)));
}, {});
...
function (_Component) {
  ...
  function Heading() {
    ...
    _this = _possibleConstructorReturn(this, (Heading.__proto__ || Object.getPrototypeOf(Heading)).apply(this, arguments));
