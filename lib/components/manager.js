...
function (_Component) {
  ...
  function Manager(props) {
    ...
    _this.state = {
      ...
      mobile: typeof window !== 'undefined' && window.innerWidth < props.contentWidth,
  ...
  _createClass(Manager, [{
    ...
    value: function _toggleOverviewMode() {
      ...
      this.context.history.replace("".concat(this.props.routePrefix, "/").concat(this.props.route.slide).concat(suffix));
    }
  }, {
    ...
    value: function _goToSlide(e) {
      ...
      if (canNavigate) {
        ...
        this.context.history.replace("".concat(this.props.routePrefix, "/").concat(slide).concat(this._getSuffix()));
      }
    }
  }, {
    key: "_prevSlide",
    value: function _prevSlide() {
      ...
      if (this._checkFragments(this.props.route.slide, false) || this.props.route.params.indexOf('overview') !== -1) {
        if (slideIndex > 0) {
          this.context.history.replace("".concat(this.props.routePrefix, "/").concat(this._getHash(slideIndex - 1)).concat(this._getSuffix()));
          localStorage.setItem('spectacle-slide', JSON.stringify({
    ...
    value: function _nextSlide() {
      ...
      if (this._checkFragments(this.props.route.slide, true) || this.props.route.params.indexOf('overview') !== -1) {
        if (slideIndex === slideReference.length - 1) {
          ...
          this.context.history.replace("".concat(this.props.routePrefix, "/").concat(this._getHash(slideIndex + offset) + this._getSuffix()));
          localStorage.setItem('spectacle-slide', JSON.stringify({
...
Object.defineProperty(Manager, "propTypes", {
  ...
  value: {
    ...
    routePrefix: _propTypes.default.string
  }
});
