...
function (_Component) {
  ...
  return Context;
}(_react.Component); // TODO(540): Refactor to non-deprecated lifecycle methods.
// https://github.com/FormidableLabs/spectacle/issues/540
// - componentWillReceiveProps
// eslint-disable-next-line react/no-deprecated


Object.defineProperty(Context, "contextTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
function (_Component2) {
  ...
  function MagicText(props) {
    ...
    _this = _possibleConstructorReturn(this, (MagicText.__proto__ || Object.getPrototypeOf(MagicText)).apply(this, arguments));
    ...
    _this.makePortal = _this.makePortal.bind(_assertThisInitialized(_this));
    _this.state = {
  ...
  _createClass(MagicText, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      _reactDom.default.render(_react.default.createElement(Context, {
        context: this.context
      }, _react.default.createElement(Deck, null, nextProps.children)), this.portal, function () {
        var styles = {};
    ...
    value: function componentDidUpdate() {
      ...
      if (this.diffs.updated) {
        Object.keys(this.diffs.updated).forEach(function (m) {
          var props = _objectSpread({}, _this4.diffs.added[m] || {}, _this4.diffs.updated[m] || {});

          var last = _objectSpread({}, _this4.lastPortalMap[m] || {});
...
Object.defineProperty(MagicText, "contextTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
Object.defineProperty(MagicText, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
