...
function (_Component) {
  ...
  function Anim() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Anim.__proto__ || Object.getPrototypeOf(Anim)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _createClass(Anim, [{
      ...
      if (animationStatus) {
        ...
        if (this.state.activeAnimation !== nextAnimation) {
          ...
          if (this.props.onAnim) {
            var forward = this.state.activeAnimation < nextAnimation;
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          fromStyle = _props.fromStyle,
          toStyle = _props.toStyle,
